...
function mod:COMBAT_LOG_EVENT_UNFILTERED(ev, timestamp, event, hideCaster, srcGUID, srcName, srcFlags, srcFlags2, destGUID, destName, destFlags, dstFlags2, spellID, ...)
